...
class BRAST2021Loader(BaseDataLoader):
    def __init__(self, config, batch_size, image_size):
        """初始化BRAST2021数据加载器"""
        print(f"初始化BRAST2021Loader，图像大小: {image_size}")
    ...
    def get_train_transforms(self):
        ...
        if config.get('structure_preserving', True):
            transform_list.append(StructurePreservingTransform())
    ...
    def get_dataset(self):
        ...
        root_dir = os.path.join(data_dir, 'brast2021', 'flair')
